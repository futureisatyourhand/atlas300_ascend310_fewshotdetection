...
class graphAttention(nn.Module):
    ...
    def forward(self, atom, bond_index, bond):
        ...
        print ('bond_index； ', bond_index.shape)
        ...
        print('bn: ', neighbor.shape, [i.shape for i in self.attend.parameters()])
        for pm in self.attend.named_parameters():
        ...
        print('in',context.shape, atom.shape, bond_index[0])
        update = self.gru(context, atom)
        print('out',update.shape)
